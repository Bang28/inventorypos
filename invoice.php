...
$pdf->SetFont('Arial', '', '10');
$pdf->Cell(112, 5, 'Date : 8-5-2023', 0, 1, 'C');
...
$pdf->SetFont('Arial', 'B', '12');
$pdf->Cell(100, 8, 'SSD', 1, 0, 'L');
$pdf->Cell(20, 8, '1', 1, 0, 'C');
$pdf->Cell(30, 8, '378.000', 1, 0, 'C');
$pdf->Cell(40, 8, '378.000', 1, 1, 'C');

$pdf->SetFont('Arial', 'B', '12');
$pdf->Cell(100, 8, 'Obeng', 1, 0, 'L');
$pdf->Cell(20, 8, '1', 1, 0, 'C');
$pdf->Cell(30, 8, '67.000', 1, 0, 'C');
$pdf->Cell(40, 8, '67.000', 1, 1, 'C');

$pdf->SetFont('Arial', 'B', '12');
$pdf->Cell(100, 8, 'Kabel FO', 1, 0, 'L');
$pdf->Cell(20, 8, '1', 1, 0, 'C');
$pdf->Cell(30, 8, '150.000', 1, 0, 'C');
$pdf->Cell(40, 8, '150.000', 1, 1, 'C');
