            ...
            <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                        <label>
                            <input type="radio" name="rd" class="minimal-red" value="Cash" checked> CASH
                        </label>
                        <label>
                            <input type="radio" name="rd" class="minimal-red" value="Card"> CARD
                        </label>
                        <label>
                            <input type="radio" name="rd" class="minimal-red" value="Check"> CHECK
                        </label>
                        </div>
